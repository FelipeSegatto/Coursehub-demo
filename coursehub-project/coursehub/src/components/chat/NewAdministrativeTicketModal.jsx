...
import { openAdministrativeTicket } from "../../services/ChatService";
...
export default function NewAdministrativeTicketModal({ onClose, onConversationStarted }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const result = await openAdministrativeTicket({ category, subject: subject.trim(), body: body.trim() });
